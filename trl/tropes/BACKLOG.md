...
**Corpus: 281 tropes · self-recognition 281/281 (100%).** (Re-measure: `tropelang selfcheck
...
- `convert/power-meta-balance-4` (this PR, 7) — **batch 4/5, frontier-balancing across scales**: The Caligula · The Evil Prince · Vichy Earth (power) · Then Let Me Be Evil · Took a Level in Kindness (arc) · Childhood Friend Romance (bonds) · Recursive Canon (meta). Power → 22, Arc → 25, Bonds → 24, Meta → 20.
